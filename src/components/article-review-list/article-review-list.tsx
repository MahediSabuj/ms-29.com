          ...
          <div key={index} className="mt-4">
            <div>
              <div className="bg-gray-100 px-3 py-2 rounded-md inline-block">
                <strong>{review.fullName}</strong> posted at {review.reviewDate}<br/>
            ...
            <div>
              ...
              <div className="inline-block">
                {review.replies?.map((rep, idx) => {
                  return (
                    <div key={index} className='bg-gray-100 p-2 rounded-md mt-4 ml-4'>
                      <strong>{rep.fullName}</strong> posted at {rep.reviewDate}<br/>
