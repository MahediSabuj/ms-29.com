...
import { DEDICATED_IP_FOR_AEMAACS as ARTICLE } from "@/data/article/aem/cloud";
      ...
      <article itemScope itemType="https://schema.org/Article">
        ...
        <div>
          ...
          <section className="pt-4">
            ...
            <Image src={AEMAACS_NEW_NETWORK_INFRASTRUCTURE} className="border border-gray-200 mt-1"
          ...
          <section className="pt-4">
            ...
            <Image src={DEDICATED_EGRESS_IP_ADDRESS} className="border border-gray-200 mt-1" width="600"
          ...
          <section className="pt-4">
            ...
            <Image src={ENABLE_NETWORK_INFRASTRUCTURE} className="border border-gray-200 mt-1" width="600"
          ...
          <section className="pt-4">
            ...
            <Image src={EGRESS_IP_NON_PROXY_HOSTS} className="border border-gray-200 mt-1" width="600"
          ...
          <section className="pt-4">
            ...
            <Image src={EGRESS_IP_PORT_FORWARDS} className="border border-gray-200 mt-1" width="600"
