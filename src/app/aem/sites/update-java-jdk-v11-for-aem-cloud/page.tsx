...
import { UPDATE_JAVA_JDK_V11_FOR_AEM_CLOUD as ARTICLE } from "@/lib/data/article/aem/sites";
    ...
    <div>
      ...
      <article itemScope itemType="https://schema.org/Article">
        ...
        <section className="pt-6">
          By default, projects are built by the Cloud Manager build process using the Oracle 8 JDK, but AEM Cloud Service customers are strongly advised
