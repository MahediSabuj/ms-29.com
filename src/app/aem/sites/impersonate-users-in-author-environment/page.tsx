      ...
      <div>
        ...
        <article itemScope itemType="https://schema.org/Article">
          ...
          <div>
            ...
            <section className="pt-3">
              <strong className="text-xl">With Admin privilege</strong>, navigate to <strong>Tools</strong> &gt;
              <strong>Security</strong> &gt; <strong>Users</strong> and
              select the user you want to impersonate. From <strong>Impersonators</strong> tab, add yourself as
              Impersonator.
            </section>
            <Image className="border p-1 mt-2"
                   src={ADD_USERS_AS_IMPERSONATORS} alt="Add Users as Impersonators"/>
            <section className="pt-2">
              Now, by accessing the User option in the header and select the user you&apos;ve set yourself as the
              impersonator for.
            </section>
