    ...
    <div>
      ...
      <article itemScope itemType="https://schema.org/Article">
        ...
        <div>
          ...
          <Image src={CONTENT_TRANSFER_DISABLE_GROUP_MIGRATION} className="border mt-1"
          ...
          <Image src={MIGRATION_SET_CLOUD_ACCELERATION_MANAGER} className="border mt-1" height="400"
          ...
          <Image src={MIGRATION_SET_EXTRACTION_KEY} className="border mt-1"
          ...
          <Image src={CONTENT_TRANSFER_SOURCE_AEM_INSTANCE} className="border mt-1"
          ...
          <Image src={MIGRATION_SET_AEM_AUTHOR} className="border mt-1" height="500"
          ...
          <Image src={MIGRATION_SET_CHECK_SIZE} className="border mt-1"
          ...
          <Image src={MIGRATION_SET_CHECK_SIZE_STATUS} className="border mt-1"
          ...
          <Image src={MIGRATION_SET_EXTRACTION} className="border mt-1"
          ...
          <Image src={EXTRACTION_PROCESS_VIEW_PROGRESS} className="border mt-1" height="500"
          ...
          <Image src={CLOUD_ACCELERATION_MANAGER_MIGRATION_SET_DETAILS} className="border mt-1"
          ...
          <Image src={CONTENT_TRANSFER_NEW_INGESTION} className="border mt-1"
          ...
          <Image src={CONTENT_INGESTION_JOB_DETAILS} className="border mt-1" height="500"
